...
type envConfig struct {
	...
	DiscordGuildID             string `env:"DISCORD_TRANSCRIBABLE_GUILD_ID,required"`
	DiscordVCID                string `env:"DISCORD_TRANSCRIBABLE_VC_ID,required"`
